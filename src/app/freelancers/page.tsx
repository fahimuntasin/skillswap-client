    ...
    <div className="min-h-[calc(100vh-4rem)] border-b border-[#d1d9e0] dark:border-[#2a2a3e]">
      <div className="mx-auto max-w-[1280px] px-8 py-16">
        <div className="mb-10">
          ...
          <h1 className="text-[40px] font-bold text-[#0F172A] dark:text-[#f8fafc] dark:text-[#f8fafc] tracking-[-0.02em]">Browse Freelancers</h1>
          <p className="mt-2 text-[#64748B] dark:text-[#94a3b8] dark:text-[#94a3b8] text-base">Find skilled professionals for your next task</p>
        </div>
            ...
            <Link key={f.id} href={`/freelancers/${f.id}`} className="group rounded-xl border border-[#F1F5F9] dark:border-[#2a2a3e] bg-white dark:bg-[#1c1a3a] dark:bg-[#1c1a3a] p-5 transition-all duration-200 hover:border-[#E2E8F0] dark:border-[#2a2a3e] dark:border-[#2a2a3e] hover:-translate-y-1">
              <div className="flex items-start gap-3 mb-4">
                ...
                <div className="min-w-0">
                  <h3 className="text-[15px] font-semibold text-[#0F172A] dark:text-[#f8fafc] dark:text-[#f8fafc] group-hover:text-[#7C3AED] transition-colors truncate">{f.name}</h3>
                  <p className="text-[13px] text-[#64748B] dark:text-[#94a3b8] dark:text-[#94a3b8]">{f.role}</p>
                  <div className="flex items-center gap-1 mt-0.5">
                    <StarIcon className="size-3 fill-amber-400 text-amber-400" />
                    <span className="text-[13px] font-medium text-[#0F172A] dark:text-[#f8fafc] dark:text-[#f8fafc]">{f.rating}</span>
                    <span className="text-[12px] text-[#94A3B8] dark:text-[#64748b]">({f.jobs} jobs)</span>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between border-t border-[#F1F5F9] dark:border-[#2a2a3e] pt-3">
                ...
                <span className="text-base font-bold text-[#0F172A] dark:text-[#f8fafc] dark:text-[#f8fafc]">${f.rate}<span className="text-[11px] font-normal text-[#94A3B8] dark:text-[#64748b]">/hr</span></span>
              </div>
            </Link>
          ))}
        </div>
