    ...
    <div className="flex min-h-[80vh] items-center justify-center px-4 py-12">
      <Card className="w-full max-w-md border-2">
        <CardHeader className="text-center">
          ...
          <CardDescription>Join SkillSwap and start working</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <form className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input id="password" type="password" placeholder="Min. 6 chars, 1 uppercase, 1 lowercase" required />
            </div>
            ...
            <Button variant="plastic" type="submit" className="w-full">
              Create Account
            </Button>
          </form>
