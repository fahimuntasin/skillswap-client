...
import { registerWithEmail, signInWithGoogle, loginWithEmail } from "@/lib/auth-client"
    ...
    <div className="flex min-h-[calc(100vh-4rem)]">
      ...
      <div className="flex flex-1 items-center justify-center px-4 sm:px-6 py-8 sm:py-12">
        <div className="w-full max-w-[420px]">
          ...
          <button ref={googleBtnRef} onClick={() => signInWithGoogle(role)} className="group relative w-full h-11 rounded-lg flex items-center justify-center gap-2.5 text-[15px] font-medium border border-[#E2E8F0] dark:border-[#2a2a3e] bg-white dark:bg-[#1a1a2e] text-[#0F172A] dark:text-[#f8fafc] cursor-pointer transition-colors overflow-hidden">
