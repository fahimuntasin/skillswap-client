...
import { registerWithEmail, loginWithEmail } from "@/lib/auth-client"
    ...
    <div className="flex min-h-[calc(100vh-4rem)]">
      ...
      <div className="hidden w-[480px] shrink-0 flex-col justify-between px-10 py-12 lg:flex border-r border-[#1e1e35]">
        ...
        <div>
          ...
          <div className="mt-5 border-t border-[#2a2a3e] pt-5">
            <p className="text-[13px] italic leading-[1.6] text-[#94a3b8]">&ldquo;Join the marketplace — post tasks or find work that fits your skills.&rdquo;</p>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-1 items-center justify-center px-4 sm:px-6 py-8 sm:py-12">
        <div className="w-full max-w-[420px]">
          ...
          <p className="mt-2 text-center text-xs text-[#64748B] dark:text-[#94a3b8]">
            Google sign-up creates a <strong>Client</strong> account. To join as Freelancer, use the form above.
          </p>
