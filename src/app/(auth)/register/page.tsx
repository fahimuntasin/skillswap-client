    ...
    <div className="flex min-h-[calc(100vh-4rem)]">
      ...
      <div className="flex flex-1 items-center justify-center px-6 py-12">
        <div className="w-full max-w-[380px]">
          <div className="mb-10"><h1 className="text-[28px] font-semibold text-[#0F172A] dark:text-[#f8fafc] tracking-[-0.02em] mb-2">Create your account</h1><p className="text-[#64748B] dark:text-[#94a3b8] text-[15px]">Enter your details to get started on SkillSwap</p></div>
          <form className="space-y-4" onSubmit={async (e) => {
            ...
            try {
              ...
              toast.success("Account created! Please log in."); router.push("/login")
            } catch { toast.error("Registration failed. Please try again.") }
            finally { setLoading(false) }
          }}>
            <div className="space-y-2"><Label htmlFor="name" className="text-[13px] font-medium text-[#0F172A] dark:text-[#e2e8f0]">Full name</Label><Input id="name" name="name" placeholder="John Doe" autoComplete="name" className="h-11 rounded-lg border-[#E2E8F0] dark:border-[#2a2a3e] dark:bg-[#1a1a2e] dark:text-[#f8fafc] text-[15px] placeholder:text-[#94A3B8] focus-visible:border-[#7C3AED] focus-visible:ring-0" /></div>
            ...
            <div className="space-y-2"><Label htmlFor="image" className="text-[13px] font-medium text-[#0F172A] dark:text-[#e2e8f0]">Profile image URL</Label><Input id="image" name="image" placeholder="https://example.com/photo.jpg" className="h-11 rounded-lg border-[#E2E8F0] dark:border-[#2a2a3e] dark:bg-[#1a1a2e] dark:text-[#f8fafc] text-[15px] placeholder:text-[#94A3B8] focus-visible:border-[#7C3AED] focus-visible:ring-0" /></div>
            <div className="space-y-2"><Label htmlFor="password" className="text-[13px] font-medium text-[#0F172A] dark:text-[#e2e8f0]">Password</Label><Input id="password" name="password" type="password" placeholder="Min. 6 characters, 1 uppercase, 1 lowercase" autoComplete="new-password" className="h-11 rounded-lg border-[#E2E8F0] dark:border-[#2a2a3e] dark:bg-[#1a1a2e] dark:text-[#f8fafc] text-[15px] placeholder:text-[#94A3B8] focus-visible:border-[#7C3AED] focus-visible:ring-0" /></div>
            <div className="flex items-center gap-2.5 pt-1"><Checkbox id="freelancer" className="size-4 rounded-[4px] border-[#E2E8F0] dark:border-[#2a2a3e] data-[state=checked]:bg-[#7C3AED] data-[state=checked]:border-[#7C3AED]" /><Label htmlFor="freelancer" className="text-[14px] font-normal text-[#475569] dark:text-[#94a3b8] cursor-pointer">Register as a <span className="font-semibold text-[#7C3AED]">Freelancer</span></Label></div>
          ...
          <p className="mt-8 text-center text-[14px] text-[#64748B] dark:text-[#94a3b8]">Already have an account? <Link href="/login" className="font-medium text-[#0F172A] dark:text-[#f8fafc] hover:text-[#7C3AED] underline underline-offset-4">Sign in</Link></p>
        </div>
      </div>
    </div>
  )
