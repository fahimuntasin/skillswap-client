  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] border-b border-[#d1d9e0] dark:border-[#2a2a3e]">
      <div className="mx-auto max-w-[1280px] px-4 sm:px-8 py-12 sm:py-16">
        <h1 className="text-[28px] sm:text-[40px] font-bold text-[#0F172A] dark:text-[#f8fafc] mb-2">My Bookmarks</h1>
        <p className="text-[#64748B] dark:text-[#94a3b8] mb-6 sm:mb-10">{bookmarks.length} saved tasks</p>
        {!tasks.length ? <p className="text-[#64748B] dark:text-[#94a3b8]">No bookmarks yet. Save tasks to view them here.</p> : (
