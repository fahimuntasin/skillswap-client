...
export default function AdminUsersPage() {
  ...
  return (
    <DashboardShell role="admin" userName="Admin">
      ...
      <div className="rounded-xl border border-[#F1F5F9] dark:border-[#2a2a3e] bg-white dark:bg-[#1c1a3a]">
        <div className="grid grid-cols-[1fr_1fr_80px_80px_120px] gap-4 border-b border-[#F1F5F9] dark:border-[#2a2a3e] px-6 py-3 text-xs font-semibold uppercase text-[#94A3B8]">
