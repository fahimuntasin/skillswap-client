...
export default function EditProfilePage() {
  ...
  async function handleSave(e: React.FormEvent) {
    ...
    try {
      ...
      notifySuccess("Profile updated!", "Your changes are live.")
      setSaved(true)
      setTimeout(() => setSaved(false), 2000)
    } catch {
      notifyError("Update failed", "Could not save your profile.")
    ...
    <DashboardShell role="freelancer" userName={user?.name || ""}>
      <div className="max-w-[640px]">
        ...
        <form className="space-y-5" onSubmit={handleSave}>
          ...
          <PrimaryActionButton loading={saving} success={saved} successLabel="Saved!">
