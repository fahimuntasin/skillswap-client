  ...
  return (
    <section ref={ref} className={`py-24 text-center transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
      <div className="mx-auto max-w-[1280px] px-6">
        ...
        <h2 className="text-[40px] font-bold text-[#0F172A] dark:text-[#f8fafc] dark:text-[#f8fafc] tracking-[-0.02em]">Ready to get work done?</h2>
        <p className="mt-3 text-base text-[#64748B] dark:text-[#94a3b8] dark:text-[#94a3b8] max-w-[480px] mx-auto">Join thousands of clients and freelancers already using SkillSwap.</p>
