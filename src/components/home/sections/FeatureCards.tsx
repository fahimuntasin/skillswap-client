...
const cards = [
  {
    ...
    desc: "Describe what you need, set a budget, and publish your task. Freelancers see it immediately.",
    link: "Post a task",
    href: "/register",
  },
  {
    ...
    desc: "Browse vetted professionals with ratings. Review proposals and hire with confidence.",
  ...
  },
  {
    ...
    desc: "Secure Stripe payments. Funds held until you approve the work. Total transparency.",
    link: "Learn more",
    href: "/register",
  },
]
...
export function FeatureCards() {
  return (
    <section className="border-b border-[#d1d9e0] py-24">
      <div className="mx-auto max-w-[1280px] px-6">
        <div className="mb-6">
          <p className="text-sm font-semibold text-[#7C3AED]">Platform features</p>
        </div>

        <div className="grid gap-px border border-[#d1d9e0] bg-[#d1d9e0] sm:grid-cols-3">
          {cards.map((card) => (
            <div key={card.title} className="bg-white p-8 sm:p-10 flex flex-col">
