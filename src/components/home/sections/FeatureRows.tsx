          ...
          >
            ...
            <div className={`rounded-xl border border-[#d1d9e0] bg-white p-8 ${f.reverse ? "lg:order-1" : ""}`}>
              <div className="space-y-3">
                {f.tag.includes("Post") && (
                  <div className="rounded-lg border border-[#d1d9e0] p-4">
                    <p className="text-sm font-semibold text-[#0F172A]">Design a modern landing page</p>
                    <p className="text-xs text-[#64748B] mt-1">Design · $150 budget · Due Jul 15</p>
                  </div>
                )}
                {f.tag.includes("top talent") && (
                  <>
                    <div className="flex items-center gap-3 rounded-lg border border-[#d1d9e0] p-3">
                      <div className="size-8 rounded-full bg-[#EDE9FE] flex items-center justify-center text-xs font-semibold text-[#7C3AED]">SC</div>
                      <div>
                        <p className="text-sm font-semibold text-[#0F172A]">Sarah Chen</p>
                        <p className="text-xs text-[#64748B]">UI Designer · $45/hr · 4.9 ★</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-3 rounded-lg border border-[#d1d9e0] p-3">
                      <div className="size-8 rounded-full bg-[#EDE9FE] flex items-center justify-center text-xs font-semibold text-[#7C3AED]">AR</div>
                      <div>
                        <p className="text-sm font-semibold text-[#0F172A]">Alex Rivera</p>
                        <p className="text-xs text-[#64748B]">Full-Stack Dev · $55/hr · 4.8 ★</p>
                      </div>
                    </div>
                  </>
                )}
