  ...
  return (
    <section className="mx-auto max-w-[1280px] px-6 py-[96px] border-b border-[#F1F5F9] dark:border-[#2a2a3e]">
      <div className="mb-12 text-center">
        ...
        <p className="mt-3 text-[#64748B] dark:text-[#94a3b8] dark:text-[#94a3b8] text-base">Browse recently posted tasks from clients worldwide</p>
      </div>
      ...
      <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
        {tasks.map((task) => (
          <div key={task.id} className="card-global group p-6">
            ...
            <h3 className="mb-2 text-[17px] font-medium text-[#0F172A] dark:text-[#f8fafc] dark:text-[#f8fafc] group-hover:text-[#7C3AED] transition-colors line-clamp-2">
              {task.title}
            </h3>
            <p className="mb-5 text-sm text-[#64748B] dark:text-[#94a3b8] dark:text-[#94a3b8]">by {task.clientName}</p>
            <div className="flex items-center justify-between text-sm">
              <span className="flex items-center gap-1.5 text-[#7C3AED] font-semibold">
                <CurrencyDollarIcon className="size-4" />
                ${task.budget}
              </span>
              <span className="flex items-center gap-1.5 text-[#64748B] dark:text-[#94a3b8] dark:text-[#94a3b8]">
