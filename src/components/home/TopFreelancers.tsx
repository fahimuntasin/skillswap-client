            ...
            <Card className="card-global group border-0 rounded-2xl">
              <CardContent className="p-5">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    <h3 className="text-[15px] font-semibold text-[#0F172A] dark:text-[#f8fafc] group-hover:text-[#7C3AED] transition-colors">
                      {f.name}
                    </h3>
                    <div className="flex items-center gap-1 text-sm">
                      <StarIcon className="size-3.5 fill-amber-400 text-amber-400" />
                      <span className="font-medium text-[#0F172A] dark:text-[#f8fafc]">{f.rating || 0}</span>
                      <span className="text-[#64748B] dark:text-[#94a3b8]">· {f.totalReviews || 0} reviews</span>
                    </div>
                  </div>
                </div>
